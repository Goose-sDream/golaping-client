...
import SharedWorker from "worker-loader!@/worker/sharedWorker.ts";
import StorageController from "@/storage/storageController";
import { isVoteExpired } from "@/utils/sessionUtils";
import { BroadcastMsg } from "@/worker/sharedWorker";
...
export const WebSocketProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    // const Worker = require("worker-loader!@/worker/sharedWorker.ts").default;
    const worker = new SharedWorker() as SharedWorker;
    worker.port.start();
